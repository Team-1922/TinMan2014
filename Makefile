...
PRJ_ROOT_DIR := $(WS_ROOT_DIR)/Robot2014
...
DEP_FILES := $(OBJ_DIR)/Shooter.d $(OBJ_DIR)/MyRobot.d $(OBJ_DIR)/DriveTrain.d \
	 $(OBJ_DIR)/Control.d
-include $(DEP_FILES)

ifeq ($(BUILD_SPEC),PPC32diab)
SUBDIRS :=
OBJECTS := $(OBJ_DIR)/Shooter.o $(OBJ_DIR)/MyRobot.o $(OBJ_DIR)/DriveTrain.o \
	 $(OBJ_DIR)/Control.o
